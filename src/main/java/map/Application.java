...
//        for(Double lat = 50.009808; lat<50.052836; lat+= 0.00224578){
//            Double lat_radian = lat * 3.14/180;
//            for(Double lon = 19.895381; lon < 19.957671; lon+=0.00224579/cos(lat_radian)) {
//                writer.write(lat.toString() + "," + lon.toString() +",3\n");
//            }
//        }
//        writer.close();
    }
